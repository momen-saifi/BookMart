						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="remove_book?bid=<%=c.getBid()%>&uid=<%=c.getUserId()%>&cid=<%=c.getCid()%>&quantity=<%=c.getQuantity()%>&pic="
										one"
										class="btn btn-danger btn-sm mr-2">-</a><%=c.getQuantity()%>



										<a
										href="cart?bid=<%=c.getBid()%>&uid=<%=c.getUserId()%>&loc=cart"
										class="btn btn-danger btn-sm ml-2">+</a></td>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Address</label> <input type="text"
										name="address" class="form-control" id="inputPassword4" value="${userobj.address }"
										required >
								</div>
							</div>
							<div class="form-row">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Pin code</label> <input
										...
										id="inputPassword4" value="${userobj.pincode }" required>
								</div>
							</div>
