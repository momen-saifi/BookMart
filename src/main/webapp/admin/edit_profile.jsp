            ...
            <div class="col-md-4 offset-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="../update_profile" method="post" onsubmit="return validatePassword()">
                            <input type="hidden" value="${userobj.id}" name="id">
                            <input type="hidden" value="admin" name="user_type">
                            <div class="form-group">
                                <label for="exampleInputFullName">Enter Full Name</label>
                                <input type="text" class="form-control" id="exampleInputFullName" aria-describedby="emailHelp" required="required" name="fname" value="${userobj.name}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="exampleInputPhoneNo" aria-describedby="emailHelp" required="required" name="phno" value="${userobj.phno}">
                            </div>

                            <div class="form-group position-relative">
                                <label for="exampleInputPassword1">Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1" required="required" name="password"  value="${userobj.password}">
                                <i class="fas fa-eye eye-icon mt-3" id="togglePassword"></i>
